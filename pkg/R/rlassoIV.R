...
#' instruments to estimate the parameter vector. The function returns an element of class \code{rlassoIV}
#'
...
#' @export
#' @rdname rlassoIV
rlassoIV <- function(x,d,y,z, post=TRUE, ...) {
...
#'
#' Objects of class \code{rlassoIV} are constructed by \code{rlassoIV.formula} or \code{rlassoIV.default}.

...
form = as.formula(paste("tw ~ ", paste(c("e401", xvar), collapse ="+"), "|",   paste(xvar, collapse = "+")))
formZ = as.formula(paste("tw ~ ", paste(c("e401", xvar), collapse ="+"), "|",   paste(c("e401", xvar), collapse = "+")))
@
...
formExt = as.formula(paste("tw ~ ", paste(c("e401", xvar2), collapse ="+"), "|",   paste(xvar2, collapse = "+")))
formZExt = as.formula(paste("tw ~ ", paste(c("e401", xvar2), collapse ="+"), "|",   paste(c("e401", xvar2), collapse = "+")))
@
